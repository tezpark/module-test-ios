...
zip -r ./build/AIAgentCore.xcframework.zip ./build/AIAgentCore.xcframework

echo "✅ XCFramework.zip 생성 완료"

swift package compute-checksum build/AIAgentCore.xcframework.zip
